            ...
            <div class="col-md-6">
                <div class="card p-3">
                    ...
                    <div class="arrow-group">
                        <a href="{{ route('cancel') }}" button class="arrow-btn left-btn">
                            <span class="arrow left"></span>
                        </a></button>

                        <a href="{{ route('confirm') }}" button class="btn btn-dark px-5 py-2">
                            ถึงป้ายแล้ว
                        </a></button>

                        <a href="{{ route('cancel') }}" button class="arrow-btn right-btn">
